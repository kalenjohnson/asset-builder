...
var BowerDirectory  = require('./BowerDirectory');
...
var Manifest = module.exports = function(path, options) {
  ...
  var bowerDirectory = BowerDirectory();
  var paths = _.pick(options, [
    'paths'
  ]);
  paths = _.merge(paths, bowerDirectory);
  var bower = mainBowerFiles(paths);
